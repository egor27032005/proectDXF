...
class KTPN1:
    def __init__(self,msp,doc,countAutomat,arrAutomat,arrTable):
    ...
    def automat(self):
        ...
        self.automats = [Automat(self.msp, self.doc,point2X + i * 35, point2Y,text=self.arrForAutomat[i]) for i in
