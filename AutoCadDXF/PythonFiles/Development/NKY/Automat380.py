...
class Automat380(Automat220):
    ...
    def files(self):
        ...
        file_path2 = os.path.join(current_dir, "../../../AbTxtFiles/NKY/Automat380Files/polyline.txt")
        file_path3 = os.path.join(current_dir, "../../../AbTxtFiles/NKY/Automat380Files/circle.txt")
